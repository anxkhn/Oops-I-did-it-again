...
def create_sample():
    db.execute("""
    INSERT INTO problems (problem_name, problem_description, test_cases, constraints, boiler_code_python, boiler_code_cpp, testing_code, function_call_cpp, function_call_python)
    VALUES (
        'Sum of Squares',
...
def check_code():
    ...
    if code == boiler_code_python or code == boiler_code_cpp:
        response = {
